...
RN06 – Tipificação Visual: O sistema deve aplicar uma identidade visual distinta (como cores, ícones ou tags) baseada no dado "Tipo do Indicador" para fins de diferenciação na interface (Derivado de: RF18).
